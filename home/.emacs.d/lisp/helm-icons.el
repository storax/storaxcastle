...
(defconst storax/icon-movie (storax/create-helm-icon "~/.emacs.d/icons/file-movie.svg"))
...
(defvar storax/helm-icons (list (cons "py" (storax/create-helm-icon "~/.emacs.d/icons/file-py.svg"))
				...
				(cons "rar" storax/icon-archive)
				(cons "xz" storax/icon-archive)
				...
				(cons "pdf" (storax/create-helm-icon "~/.emacs.d/icons/file-pdf.svg"))
				...
				(cons "mp4" storax/icon-movie)
				(cons "mkv" storax/icon-movie)
				(cons "avi" storax/icon-movie)
				(cons "mov" storax/icon-movie)
				(cons "flv" storax/icon-movie)
				(cons "mpeg" storax/icon-movie)
				(cons "mpg" storax/icon-movie)
